...
export const resetPasswordCodeEmailTemplateString = ({ code, userName }: ResetPasswordCodeEmailTemplateStringProps) => {
    ...
    <p style="font-size: 1rem; margin-bottom: 0.25rem;">Olá <strong>${userName}</strong>, foi solicitado uma nova senha para sua conta, esse é seu código de verificação:</p>
